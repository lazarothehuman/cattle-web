...
@ListenerFor(sourceClass = OlympiaMenu.class, systemEventClass = PostAddToViewEvent.class)
public class OlympiaMenu extends AbstractMenu implements Widget,ComponentSystemEventListener {

    public static final String COMPONENT_TYPE = "org.primefaces.component.OlympiaMenu";
    public static final String COMPONENT_FAMILY = "org.primefaces.component";
    private static final String DEFAULT_RENDERER = "org.primefaces.component.olympiaMenuRenderer";
